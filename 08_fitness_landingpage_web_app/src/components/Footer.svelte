<footer class="bg-secondary text-white py-12">
  <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
      <!-- Logo & Description -->
      <div>
        <span class="text-2xl font-bold">FitLife</span>
        <p class="mt-4 text-gray-400">
          Membantu Anda mencapai target fitness dengan program yang
          terstruktur dan supportif.
        </p>
      </div>
      ...
      <div>
        ...
        <ul class="space-y-2">
          <li>
            <a href="/#features" class="text-gray-400 hover:text-white">Fitur</a>
          </li>
          <li>
            <a href="/#testimonials" class="text-gray-400 hover:text-white">Testimoni</a>
          </li>
          <li>
            <a href="/#pricing" class="text-gray-400 hover:text-white">Harga</a>
          </li>
          <li>
      ...
      <div>
        ...
        <ul class="space-y-2 text-gray-400">
          ...
          <li>Alamat: Jl. Fitness No. 123, Jakarta</li>
        </ul>
      </div>
